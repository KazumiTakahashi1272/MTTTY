...
void TransferRepeatCreate(LPCTSTR lpszFileName, DWORD dwFrequency)
{
    ...
    if (lpBuf == NULL) {
        ErrorReporter("HeapAlloc (書込みヒープでのデータブロック).\r\nファイルが大きいです");
        TransferRepeatDestroy();
        return;
    }
